...
// animations/transitions (via the html.battery-save class below), the rocket
// slide tween, and the dice tumble. The map stays fully interactive (pan /
// zoom / hover and state changes still repaint on demand), it just no longer
// animates on its own, which is the main battery cost on mobile.
//
