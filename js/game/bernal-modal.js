  ...
  function repaint() {
    ...
    const actionSpecs = [
      anchored
        ...
        : { cb: opts.onAnchor, label: '⚓ Anchor', title: 'Anchor this Bernal as a fixed space station here and gain its colony ability (a colonist exomigrates to you). Needs a home orbit or an adjacent fresh factory. Costs your operation.' },
