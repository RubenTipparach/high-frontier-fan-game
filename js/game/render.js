...
// The marker sprite for a routing node, read from the SINGLE SOURCE OF TRUTH
// (data/node-tags.js, generated by scripts/gen-node-tags.mjs): player site-notes
// tags merged with the planner's own burn flags, with aerobrake => hazard. Null
// when the node carries no marker. No runtime fallback - node-tags.js is
// comprehensive (it already folds in every untagged burn's lander / hazard).
