...
export const TUTORIAL_STEPS = [
  ...
  { id: 'et-generator',        pose: 'point', target: 'et-produce',
    ...
    instruction: 'ET-produce a generator too. Building a Factory decommissions the refinery + robonaut AND their generator, so your Phobos kit needs its own power source.' },
