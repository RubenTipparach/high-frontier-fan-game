...
export const TUTORIAL_STEPS = [
  ...
  { id: 'fly-phobos',          pose: 'point', target: 'move',
    title: 'Hop to Phobos',
    instruction: 'Load your kit FIRST: move the produced robonaut + refinery from the Deimos outpost onto your rocket (a free Cargo Transfer). You cannot leave without it. Then plot a route and hop to Phobos.' },
